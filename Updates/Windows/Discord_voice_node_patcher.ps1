...
$Script:OffsetsMeta = @{
    ...
    DiscordAppVersion = "1.0.9242"
    Size              = 14780344
    MD5               = "2ebb4c455b396827903fe3cf352a8acd"
}

$Script:Offsets = @{
    CreateAudioFrame_ChannelAssign_Mov                      = 0x00131241
    AudioEncoderOpusConfig_Ctor_Channels_Imm02              = 0x003DDBA4
    CapturedAudioProcessor_MonoDownmix_NopJmp               = 0x000DF956
    CommitAudioCodec_ChannelCount_Imm02                     = 0x005903CB
    CommitAudioCodec_SuccessBranch_Jmp                      = 0x005903D7
    ApplySettings_BitrateCalcLow_Channels_Mov248k           = 0x005907F6
    ApplySettings_BitrateCalcMid_Channels_Mov248k           = 0x00590813
    ApplySettings_BitrateCalcHigh_Channels_Mov248k          = 0x00590828
    RecreateEncoder_BitrateCalcLow_Channels_Mov248k         = 0x005956DC
    RecreateEncoder_BitrateCalcMid_Channels_Mov248k         = 0x005956F9
    RecreateEncoder_BitrateCalcHigh_Channels_Mov248k        = 0x0059570E
    SetBitrateClamp_Max248k_Cmp                             = 0x005957E6
    SetBitrateClamp_Max248k_Mov                             = 0x005957EC
    AudioBitrateAdaptorCalc32k_Channels_Mov248k             = 0x00AA069E
    AudioBitrateAdaptorCalc48k_Channels_Mov248k             = 0x00AA06B2
    AudioBitrateAdaptorCalc60k_Channels_Mov248k             = 0x00AA06C3
    SetBitrate_Imm64_Imm248k                                = 0x00592651
    SetBitrate_OrMask_Nop3                                  = 0x00592659
    SetTargetBitrate_Mulss_Nop6                             = 0x00592691
    GetMultipliedBitrate_Mulss_Nop7                         = 0x005931CD
    GetMultipliedBitrate_Entry_IdentityRet                  = 0x00593190
    SetTargetBitrate_ClampMax248k_Cmp                       = 0x00592615
    SetTargetBitrate_ClampMax248k_Mov                       = 0x0059261B
    ApplySettings_MaxAvgBitrateClamp248k_Cmp                = 0x00590900
    ApplySettings_MaxAvgBitrateClamp248k_Mov                = 0x00590906
    EncoderOpusImpl_RelayClamp248k_Cmp                      = 0x0059298C
    EncoderOpusImpl_RelayClamp248k_Mov                      = 0x00592991
    SelectSampleRate_Cmov48k_Nop3                           = 0x00590533
    WebRtcSplHighPass_Dispatch_MovRet                       = 0x0059C640
    hp_cutoff_Callback_InjectShellcode                      = 0x0091E4B0
    dc_reject_Callback_InjectShellcode                      = 0x0091E690
    ChannelDownmix_Entry_Ret                                = 0x0091A820
    AudioEncoderOpusConfig_IsOK_MovTrueRet                  = 0x003DDE40
    CodecMismatchThrow_Entry_Ret                            = 0x002F5EB0
    AudioEncoderOpusConfig_Ctor_Bitrate_Imm248k             = 0x003DDBAE
    AudioEncoderMultiChannelOpusConfig_Ctor_Bitrate_Imm248k = 0x003DD4B7
    AudioEncoderOpusConfig_Ctor_FrameMs_Imm10               = 0x003DDB95
    AudioEncoderOpusConfig_Ctor_Application_ImmAudio        = 0x003DDBB9
    CELT_Force                                              = 0x0091A618
    CELT_DefaultMode                                        = 0x0091A694
    NetEqDelayManager_MsPerLoss_Imm0                        = 0x00AE74DD
    PacerBlockAudio_Flag_XorFalse                           = 0x007301A2
    SetAutomaticGainControlConfig_Entry_Ret                 = 0x0008DFC0
    SetAutomaticGainControl_Entry_Ret                       = 0x0008E360
    SetNoiseSuppression_Entry_Ret                           = 0x0008DCB0
    SetEchoCancellation_Entry_Ret                           = 0x0008D380
    SetEchoCancellationPreEcho_Entry_Ret                    = 0x0008D680
    EnableBuiltInAEC_Entry_Ret                              = 0x0008D080
    SetNoiseCancellation_Entry_Ret                          = 0x0008E680
    SetNoiseCancellationDuringProcessing_Entry_Ret          = 0x0008F210
}
