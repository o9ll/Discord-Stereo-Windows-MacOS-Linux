...
$Script:OffsetsMeta = @{
    ...
    DiscordAppVersion = "1.0.9239"
    Size          = 14661048
    MD5           = "d733d84efbdae3f621ede1b3e4741751"
}

$Script:Offsets = @{
    CreateAudioFrame_ChannelAssign_Mov                      = 0x124C41
    AudioEncoderOpusConfig_Ctor_Channels_Imm02              = 0x3CB104
    CapturedAudioProcessor_MonoDownmix_NopJmp               = 0xDC265
    CommitAudioCodec_ChannelCount_Imm02                     = 0x57A88B
    CommitAudioCodec_SuccessBranch_Jmp                      = 0x57A897
    ApplySettings_BitrateCalcLow_Channels_Mov248k           = 0x57ACB6
    ApplySettings_BitrateCalcMid_Channels_Mov248k           = 0x57ACD3
    ApplySettings_BitrateCalcHigh_Channels_Mov248k          = 0x57ACE8
    RecreateEncoder_BitrateCalcLow_Channels_Mov248k         = 0x57FB9C
    RecreateEncoder_BitrateCalcMid_Channels_Mov248k         = 0x57FBB9
    RecreateEncoder_BitrateCalcHigh_Channels_Mov248k        = 0x57FBCE
    SetBitrateClamp_Max248k_Cmp                             = 0x57FCA6
    SetBitrateClamp_Max248k_Mov                             = 0x57FCAC
    AudioBitrateAdaptorCalc32k_Channels_Mov248k             = 0xA8ABDE
    AudioBitrateAdaptorCalc48k_Channels_Mov248k             = 0xA8ABF2
    AudioBitrateAdaptorCalc60k_Channels_Mov248k             = 0xA8AC03
    SetBitrate_Imm64_Imm248k                                = 0x57CB11
    SetBitrate_OrMask_Nop3                                  = 0x57CB19
    SetTargetBitrate_Mulss_Nop6                             = 0x57CB51
    GetMultipliedBitrate_Mulss_Nop7                         = 0x57D68D
    GetMultipliedBitrate_Entry_IdentityRet                  = 0x57D650
    SetTargetBitrate_ClampMax248k_Cmp                       = 0x57CAD5
    SetTargetBitrate_ClampMax248k_Mov                       = 0x57CADB
    ApplySettings_MaxAvgBitrateClamp248k_Cmp                = 0x57ADC0
    ApplySettings_MaxAvgBitrateClamp248k_Mov                = 0x57ADC6
    EncoderOpusImpl_RelayClamp248k_Cmp                      = 0x57CE4C
    EncoderOpusImpl_RelayClamp248k_Mov                      = 0x57CE51
    SelectSampleRate_Cmov48k_Nop3                           = 0x57A9F3
    WebRtcSplHighPass_Dispatch_MovRet                       = 0x586B00
    hp_cutoff_Callback_InjectShellcode                      = 0x9089B0
    dc_reject_Callback_InjectShellcode                      = 0x908B90
    ChannelDownmix_Entry_Ret                                = 0x904D20
    AudioEncoderOpusConfig_IsOK_MovTrueRet                  = 0x3CB3A0
    CodecMismatchThrow_Entry_Ret                            = 0x2E36E0
    AudioEncoderOpusConfig_Ctor_Bitrate_Imm248k             = 0x3CB10E
    AudioEncoderMultiChannelOpusConfig_Ctor_Bitrate_Imm248k = 0x3CAA17
    AudioEncoderOpusConfig_Ctor_FrameMs_Imm10               = 0x3CB0F5
    AudioEncoderOpusConfig_Ctor_Application_ImmAudio        = 0x3CB119
    RecreateEncoderInstance_FecBranch_Jmp                   = 0x57BBA7
    MultiChannelRecreateEncoder_FecBranch_Jmp               = 0x57F01B
    SetFec_EnableBranch_Jmp                                 = 0x57C354
    RecreateEncoderInstance_DtxBranch_Jmp                   = 0x57BC74
    MultiChannelRecreateEncoder_DtxBranch_Jmp               = 0x57F19C
    SetDtx_EnableBranch_Jmp                                 = 0x57C404
    CopyRedEncodeImpl_RedundantCopy_JmpNear                 = 0x5ACEFD
    NetEqDelayManager_MsPerLoss_Imm0                        = 0xAD1A1D
    PacerBlockAudio_Flag_XorFalse                           = 0x71A6B2
    SetAutomaticGainControlConfig_Entry_Ret                 = 0x8BCF0
    SetAutomaticGainControl_Entry_Ret                       = 0x8C090
    SetNoiseSuppression_Entry_Ret                           = 0x8B9E0
    SetEchoCancellation_Entry_Ret                           = 0x8B3C0
    SetEchoCancellationPreEcho_Entry_Ret                    = 0x8B6C0
    EnableBuiltInAEC_Entry_Ret                              = 0x8B0C0
    SetNoiseCancellation_Entry_Ret                          = 0x8C3B0
    SetNoiseCancellationDuringProcessing_Entry_Ret          = 0x8CF40
}
