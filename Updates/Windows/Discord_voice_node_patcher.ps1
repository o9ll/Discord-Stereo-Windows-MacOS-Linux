...
$Script:Offsets = @{
    CreateAudioFrame_ChannelAssign_Mov                      = 0x0013AC11
    AudioEncoderOpusConfig_Ctor_Channels_Imm02              = 0x003EBAA4
    CapturedAudioProcessor_MonoDownmix_NopJmp               = 0x000E8056
    CommitAudioCodec_ChannelCount_Imm02                     = 0x0059ADBB
    CommitAudioCodec_SuccessBranch_Jmp                      = 0x0059ADC7
    ApplySettings_BitrateCalcLow_Channels_Mov248k           = 0x0059B1E6
    ApplySettings_BitrateCalcMid_Channels_Mov248k           = 0x0059B203
    ApplySettings_BitrateCalcHigh_Channels_Mov248k          = 0x0059B218
    RecreateEncoder_BitrateCalcLow_Channels_Mov248k         = 0x005A00CC
    RecreateEncoder_BitrateCalcMid_Channels_Mov248k         = 0x005A00E9
    RecreateEncoder_BitrateCalcHigh_Channels_Mov248k        = 0x005A00FE
    SetBitrateClamp_Max248k_Cmp                             = 0x005A01D6
    SetBitrateClamp_Max248k_Mov                             = 0x005A01DC
    AudioBitrateAdaptorCalc32k_Channels_Mov248k             = 0x00AADADE
    AudioBitrateAdaptorCalc48k_Channels_Mov248k             = 0x00AADAF2
    AudioBitrateAdaptorCalc60k_Channels_Mov248k             = 0x00AADB03
    SetBitrate_Imm64_Imm248k                                = 0x0059D041
    SetBitrate_OrMask_Nop3                                  = 0x0059D049
    SetTargetBitrate_Mulss_Nop6                             = 0x0059D081
    GetMultipliedBitrate_Mulss_Nop7                         = 0x0059DBBD
    GetMultipliedBitrate_Entry_IdentityRet                  = 0x0059DB80
    SetTargetBitrate_ClampMax248k_Cmp                       = 0x0059D005
    SetTargetBitrate_ClampMax248k_Mov                       = 0x0059D00B
    ApplySettings_MaxAvgBitrateClamp248k_Cmp                = 0x0059B2F0
    ApplySettings_MaxAvgBitrateClamp248k_Mov                = 0x0059B2F6
    EncoderOpusImpl_RelayClamp248k_Cmp                      = 0x0059D37C
    EncoderOpusImpl_RelayClamp248k_Mov                      = 0x0059D381
    SelectSampleRate_Cmov48k_Nop3                           = 0x0059AF23
    WebRtcSplHighPass_Dispatch_MovRet                       = 0x005A7030
    hp_cutoff_Callback_InjectShellcode                      = 0x0092BAA0
    dc_reject_Callback_InjectShellcode                      = 0x0092BC80
    ChannelDownmix_Entry_Ret                                = 0x00927E10
    AudioEncoderOpusConfig_IsOK_MovTrueRet                  = 0x003EBD40
    CodecMismatchThrow_Entry_Ret                            = 0x00303630
    AudioEncoderOpusConfig_Ctor_Bitrate_Imm248k             = 0x003EBAAE
    AudioEncoderMultiChannelOpusConfig_Ctor_Bitrate_Imm248k = 0x003EB3B7
    AudioEncoderOpusConfig_Ctor_FrameMs_Imm10               = 0x003EBA95
    AudioEncoderOpusConfig_Ctor_Application_ImmAudio        = 0x003EBAB9
    CELT_Force                                              = 0x00927C08
    CELT_DefaultMode                                        = 0x00927C84
    NetEqDelayManager_MsPerLoss_Imm0                        = 0x00AF491D
    PacerBlockAudio_Flag_XorFalse                           = 0x0073C282
    SetAutomaticGainControlConfig_Entry_Ret                 = 0x00095310
    SetAutomaticGainControl_Entry_Ret                       = 0x000956B0
    SetNoiseSuppression_Entry_Ret                           = 0x00095000
    SetEchoCancellation_Entry_Ret                           = 0x000946D0
    SetEchoCancellationPreEcho_Entry_Ret                    = 0x000949D0
    EnableBuiltInAEC_Entry_Ret                              = 0x000943D0
    SetNoiseCancellation_Entry_Ret                          = 0x000959D0
    SetNoiseCancellationDuringProcessing_Entry_Ret          = 0x00096560
}
